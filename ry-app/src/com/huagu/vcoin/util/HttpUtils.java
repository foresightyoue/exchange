...
public class HttpUtils {
    ...
    // wx_ssl_context = SSLContexts.custom().loadKeyMaterial(keystore,
    // keyPassword).build();
    // } catch (Exception e) {
    // e.printStackTrace();
    // }
    ...
    public static Map<String,String> readRequestParam(HttpServletRequest request, HttpServletResponse response) {
