...
public class FsubscriptionlogDAO extends HibernateDaoSupport {
    private static final Logger log = LoggerFactory.getLogger(FsubscriptionlogDAO.class);
    // property constants
    ...
    public Fsubscriptionlog findById(java.lang.Integer id) {
        ...
        try {
            Fsubscriptionlog instance = (Fsubscriptionlog) getSession()
                    .get("com.huagu.vcoin.main.model.Fsubscriptionlog", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fsubscriptionlog> findByExample(Fsubscriptionlog instance) {
        ...
        try {
            List<Fsubscriptionlog> results = getSession().createCriteria("com.huagu.vcoin.main.model.Fsubscriptionlog")
    ...
    public List findByProperty(String propertyName, Object value) {
        log.debug("finding Fsubscriptionlog instance with property: " + propertyName + ", value: " + value);
        try {
            String queryString = "from Fsubscriptionlog as model where model." + propertyName + "= ?";
    ...
    public Fsubscriptionlog merge(Fsubscriptionlog detachedInstance) {
        ...
        try {
            Fsubscriptionlog result = (Fsubscriptionlog) getSession().merge(detachedInstance);
