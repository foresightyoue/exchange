...
public class FaboutDAO extends HibernateDaoSupport {
    ...
    public Fabout findById(java.lang.Integer id) {
        ...
        try {
            Fabout instance = (Fabout) getSession().get("com.huagu.vcoin.main.model.Fabout", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Fabout> findByExample(Fabout instance) {
        ...
        try {
            List<Fabout> results = getSession().createCriteria("com.huagu.vcoin.main.model.Fabout")
    ...
    public List findByProperty(String propertyName, Object value) {
        log.debug("finding Fabout instance with property: " + propertyName + ", value: " + value);
        try {
            String queryString = "from Fabout as model where model." + propertyName + "= ?";
