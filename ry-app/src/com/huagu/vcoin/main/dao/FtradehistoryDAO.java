...
public class FtradehistoryDAO extends HibernateDaoSupport {
    private static final Logger log = LoggerFactory.getLogger(FtradehistoryDAO.class);
    // property constants
    ...
    public Ftradehistory findById(java.lang.Integer id) {
        ...
        try {
            Ftradehistory instance = (Ftradehistory) getSession().get("com.huagu.vcoin.main.model.Ftradehistory", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Ftradehistory> findByExample(Ftradehistory instance) {
        ...
        try {
            List<Ftradehistory> results = getSession().createCriteria("com.huagu.vcoin.main.model.Ftradehistory")
    ...
    public List findByProperty(String propertyName, Object value) {
        log.debug("finding Ftradehistory instance with property: " + propertyName + ", value: " + value);
        try {
            String queryString = "from Ftradehistory as model where model." + propertyName + "= ?";
    ...
    public Ftradehistory merge(Ftradehistory detachedInstance) {
        ...
        try {
            Ftradehistory result = (Ftradehistory) getSession().merge(detachedInstance);
