...
public class CoinVoteController extends BaseController {
    ...
    public ModelAndView coinVoteLogList() throws Exception {
        ...
        List<Fcoinvotelog> list = this.coinVotelogService.list((currentPage - 1) * numPerPage, numPerPage, filter + "",
                true);
    ...
    public ModelAndView saveCoinVote(@RequestParam(required = false) MultipartFile filedata, String fcnName,
            String fshortName, String fenName, String fdesc) throws Exception {
    ...
    public ModelAndView updateCoinVote(@RequestParam(required = false) MultipartFile filedata, String fcnName,
            String fshortName, String fenName, String fdesc, int fid) throws Exception {
