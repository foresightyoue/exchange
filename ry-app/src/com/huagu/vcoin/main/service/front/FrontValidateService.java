...
import com.huagu.vcoin.main.dao.EmailvalidateDAO;
...
import com.huagu.vcoin.main.dao.FvalidateemailDAO;
import com.huagu.vcoin.main.dao.FvalidatemessageDAO;
...
public class FrontValidateService extends BaseService {
    ...
    public boolean saveSendFindPasswordMail(String ip, Fuser fuser, String email, HttpServletRequest request) {
        ...
        try {
            ...
            validateemails.setFtitle(this.getSystemArgs(ConstantKeys.englishName) + "找回登录密码邮件");
            validateemails.setFcontent(this.getSystemArgs(ConstantKeys.findPasswordMail)
                    .replace("#firstLevelDomain#", this.getSystemArgs(ConstantKeys.firstLevelDomain))
                    .replace("#url#",
                            new Constant().Domain + "validate/resetPwd.html?uid=" + fuser.getFid() + "&&uuid=" + UUID)
