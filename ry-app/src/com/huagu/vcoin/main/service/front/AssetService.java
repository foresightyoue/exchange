...
import com.huagu.vcoin.main.dao.FassetDAO;
...
public class AssetService {
    ...
    public boolean updateAllAssetsDetail() {
        List<Fvirtualcointype> fvirtualcointypes = this.fvirtualcointypeDAO.findByParam(0, 0, "", false,
        ...
        for (Fasset fasset : fassets) {
            ...
            List<Fvirtualwallet> fvirtualwallets = this.fvirtualwalletDAO.findByParam(0, 0,
                    " where fuser.fid=" + fasset.getFuser().getFid(), false, Fvirtualwallet.class);
