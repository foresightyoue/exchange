        ...
        for (String name : channelNames) {
            if (name.equals(channel)) {
                if (name.equals(ChannelConstant.constantmap)) {
                    ...
                    } else if ("virtualCoinType".equalsIgnoreCase(message)) {
                        constantMap.virtualCoinType();
                    } else if ("allWithdrawCoins".equalsIgnoreCase(message)) {
                        constantMap.allWithdrawCoins();
                    } else if ("allRechargeCoins".equalsIgnoreCase(message)) {
                        constantMap.allRechargeCoins();
                    } else if ("ffriendlinks".equalsIgnoreCase(message)) {
                        constantMap.ffriendlinks();
                    } else if ("quns".equalsIgnoreCase(message)) {
                        constantMap.quns();
                    } else if ("webinfo".equalsIgnoreCase(message)) {
                        constantMap.webinfo();
                    } else if ("tradehistory".equalsIgnoreCase(message)) {
                        constantMap.tradehistory();
                    } else if ("news".equalsIgnoreCase(message)) {
                        constantMap.news();
                    } else if ("fbs".equalsIgnoreCase(message)) {
                        constantMap.fbs();
                    } else if ("tradeMappings".equalsIgnoreCase(message)) {
                        constantMap.tradeMappings();
                    } else if ("ftradehistory7D".equalsIgnoreCase(message)) {
                        constantMap.ftradehistory7D();
                    } else if ("totalActUser".equalsIgnoreCase(message)) {
                        constantMap.totalActUser();
                    } else if ("totalActAmt".equalsIgnoreCase(message)) {
