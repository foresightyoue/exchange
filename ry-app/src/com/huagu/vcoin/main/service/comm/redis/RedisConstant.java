...
public class RedisConstant {
    ...
    public static String getIndexJsonKey(int ftrademapping, int key) {
        ...
        sb.append(ftrademapping).append("-").append(key);
        return sb.toString();
    }
    ...
    public static String getperiodJsonKey(int ftrademapping, int step) {
        ...
        sb.append(ftrademapping).append("-").append(step);
        return sb.toString();
    }
    ...
    public static String getAllZiCanAccount() {
        StringBuffer sb = new StringBuffer("getAllZiCanAccount-");
        return sb.toString();
