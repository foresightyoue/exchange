 ...
 */
@Entity
@Table(name = "fcoinvote", catalog = "vcoindb")
...
public class Fcoinvote implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 2048271722566267811L;
    private int fid;
    private int version;
    ...
    /** full constructor */
    public Fcoinvote(String fcnName, String fenName, String fshortName, String fdesc, String furl, int fstatus,
            int fyes, int fno) {
