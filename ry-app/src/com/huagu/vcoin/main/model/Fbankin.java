 ...
 */
@Entity
@Table(name = "fbankin", catalog = "vcoindb")
public class Fbankin implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 2562922130169633052L;
    private Integer fid;
    private Integer uid;
    private Double rmb;
    ...
    /** full constructor */
    public Fbankin(Integer uid, Double rmb, String bankname, Timestamp tday, Integer ok) {
        this.uid = uid;
        this.rmb = rmb;
