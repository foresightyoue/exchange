 ...
 */
@Entity
@Table(name = "ffriendlink", catalog = "vcoindb")
...
public class Ffriendlink implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -3714687824855433153L;
    private int fid;
    ...
    /** full constructor */
    public Ffriendlink(String fname, String fdescription, int forder, Timestamp fcreateTime, String furl, int ftype) {
        this.fname = fname;
