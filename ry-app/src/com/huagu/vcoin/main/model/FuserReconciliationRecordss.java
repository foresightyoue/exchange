...
public class FuserReconciliationRecordss implements java.io.Serializable{
    ...
    private double fsccftotal;
    private double fsccffrozen;
    private double fsccTotal;
    private double faccountsUsdtTotal;
    private double faccountsAtTotal;
    private double faccountsPcTotal;
    private double faccountsSccTotal;
    ...
    private double fbuySccSellUsdtCount;
    private double fbuySccCount;
	private double fbuyUsdtSellSccCount;
    private double fsellSccCount;
	...
	@Column(name = "fotcBuyUsdt", precision = 12, scale = 0)
	public double getFotcBuyUsdt() {
		return fotcBuyUsdt;
	}

	public void setFotcBuyUsdt(double fotcBuyUsdt) {
		this.fotcBuyUsdt = fotcBuyUsdt;
	}
	...
	@Column(name = "fsccDifference", precision = 12, scale = 0)
	public double getFsccDifference() {
		return fsccDifference;
	}

	public void setFsccDifference(double fsccDifference) {
		this.fsccDifference = fsccDifference;
	}

	@Column(name = "fsccftotal", precision = 12, scale = 0)
	public double getFsccftotal() {
		return fsccftotal;
	}

	public void setFsccftotal(double fsccftotal) {
		this.fsccftotal = fsccftotal;
	}

	@Column(name = "fsccffrozen", precision = 12, scale = 0)
	public double getFsccffrozen() {
		return fsccffrozen;
	}

	public void setFsccffrozen(double fsccffrozen) {
		this.fsccffrozen = fsccffrozen;
	}

	@Column(name = "fsccTotal", precision = 12, scale = 0)
	public double getFsccTotal() {
		return fsccTotal;
	}

	public void setFsccTotal(double fsccTotal) {
		this.fsccTotal = fsccTotal;
	}

	@Column(name = "faccountsSccTotal", precision = 12, scale = 0)
	public double getFaccountsSccTotal() {
		return faccountsSccTotal;
	}

	public void setFaccountsSccTotal(double faccountsSccTotal) {
		this.faccountsSccTotal = faccountsSccTotal;
	}

	@Column(name = "fbuySccSellUsdtCount", precision = 12, scale = 0)
	public double getFbuySccSellUsdtCount() {
		return fbuySccSellUsdtCount;
	}

	public void setFbuySccSellUsdtCount(double fbuySccSellUsdtCount) {
		this.fbuySccSellUsdtCount = fbuySccSellUsdtCount;
	}

	@Column(name = "fbuySccCount", precision = 12, scale = 0)
	public double getFbuySccCount() {
		return fbuySccCount;
	}

	public void setFbuySccCount(double fbuySccCount) {
		this.fbuySccCount = fbuySccCount;
	}

	@Column(name = "fbuyUsdtSellSccCount", precision = 12, scale = 0)
	public double getFbuyUsdtSellSccCount() {
		return fbuyUsdtSellSccCount;
	}

	public void setFbuyUsdtSellSccCount(double fbuyUsdtSellSccCount) {
		this.fbuyUsdtSellSccCount = fbuyUsdtSellSccCount;
	}

	@Column(name = "fsellSccCount", precision = 12, scale = 0)
	public double getFsellSccCount() {
		return fsellSccCount;
	}

	public void setFsellSccCount(double fsellSccCount) {
		this.fsellSccCount = fsellSccCount;
	}
