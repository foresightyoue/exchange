 ...
 */
@Entity
@Table(name = "fwebbaseinfo", catalog = "vcoindb")
...
public class Fwebbaseinfo implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 4736449734914089166L;
    private int fid;
    ...
    /** full constructor */
    public Fwebbaseinfo(String ftitle, String fkeywords, String fdescription, String fcopyRights, String fbeianInfo,
            String fsystemMail) {
        this.ftitle = ftitle;
