 ...
 */
@Entity
@Table(name = "flog", catalog = "vcoindb")
...
public class Flog implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 7863850135386446081L;
    private Integer fid;
    ...
    /** full constructor */
    public Flog(Timestamp fcreateTime, Integer ftype, String fkey1, String fkey2, String fkey3, String fkey4,
            String fkey5, String fkey6) {
