package com.huagu.vcoin.security;
...
public class SecurityFilter implements Filter {
    ...
    private static int MC = Integer.parseInt(ServerConfig.getInstance().getProperty("security.minuteCount", "100"));
    private static int SC = Integer.parseInt(ServerConfig.getInstance().getProperty("security.secoundCount", "20"));
