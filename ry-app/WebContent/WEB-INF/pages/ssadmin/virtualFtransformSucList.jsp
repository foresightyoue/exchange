...
<form id="pagerForm" method="post"
    ...
    <input type="hidden" name="status" value="${param.status}"> <input
        ...
        name="fStatus" value="${fStatus}">
</form>

<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);"
        action="ssadmin/virtualFtransformSucList.html" method="post">
        <div class="searchBar">
            ...
            <table class="searchContent">
                <tr>
                    ...
                    <td>审核状态:<select type="combox" name="fStatus">
                         <c:forEach items="${statusMap}" var="fstatus">
                             <c:if test="${fstatus.key==fStatus}">
                                  <option value="${fstatus.key}" selected="true">${fstatus.value}</option>
                             </c:if>
                             <c:if test="${fstatus.key != fStatus}">
