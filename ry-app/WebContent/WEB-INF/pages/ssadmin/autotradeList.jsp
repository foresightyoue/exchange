        ...
        <tbody>
            <c:forEach items="${autotradeList}" var="autotrade"
                ...
                <tr target="sid_user" rel="${autotrade.fid}">
                    ...
                    <td><fmt:formatDate value="${autotrade.fcreatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                    <td><fmt:formatNumber value="${autotrade.fstandardprice}" pattern="##.######" maxIntegerDigits="10" maxFractionDigits="6"/></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
