...
<div class="pageContent">
	<div class="panelBar">
		...
		<li class="line">line</li>
			<li><a class="icon" href="ssadmin/virtualCapitalAllListExport.html"
		...
		<tbody>
			<c:forEach items="${virtualCapitaloperationList}"
				...
				<tr target="sid_user" rel="${virtualCapitaloperation.fid}">
					...
					<td><fmt:formatDate value="${virtualCapitaloperation.fcreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
					<td><fmt:formatDate value="${virtualCapitaloperation.flastUpdateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
