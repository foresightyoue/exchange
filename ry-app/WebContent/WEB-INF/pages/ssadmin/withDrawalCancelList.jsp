...
<form id="pagerForm" method="post"
	action="ssadmin/withDrawalCancelList.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="ssadmin/withDrawalCancelList.html" method="post">
		<div class="searchBar">
		...
		<thead>
			<tr>
				...
				<th width="60" orderField=fcreateTime
					<c:if test='${param.orderField == "fcreateTime" }'> class="${param.orderDirection}"  </c:if>>挂单状态</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${ctctradeList}"
				var="ctctradeList" varStatus="num">
				<tr target="sid_user" rel="${ctctradeListitme.FUs_fId}">
					<td>${num.index +1}</td>
