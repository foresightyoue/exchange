	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="ssadmin/userForbbin6.html">
				<li>
				    <a class="edit" href="ssadmin/getAdminInfo.html?uid={sid_user}&type=1&amp;url=ssadmin/updatePhone" target="dialog" rel="updatePhone" height="300" width="600"><span>修改绑定手机号</span></a></a>
				</li>
			</shiro:hasPermission>
		</ul>
	</div>
		...
		<tbody>
			<c:forEach items="${adminList}" var="admin" varStatus="num">
				<tr target="sid_user" rel="${admin.fid}">
					...
					<td><fmt:formatDate value="${admin.fcreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
