		...
		<tbody>
			<c:forEach items="${articleTypeList}" var="articleType"
				...
				<tr target="sid_user" rel="${articleType.fid}">
					...
					<td><fmt:formatDate value="${articleType.flastCreateDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
					<td><fmt:formatDate value="${articleType.flastModifyDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
