...
<form id="pagerForm" method="post" action="ssadmin/capitalOutList3.html">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="ssadmin/capitalOutList3.html" method="post">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="ssadmin/capitalOutAudit1.html">
				...
				postType="string" href="ssadmin/capitalOutaAuditAll.html"
