    ...
    <form method="post" action="ssadmin/updateAutotrade.html"
        ...
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>
                <dt>标准成交价格：</dt>
                <dd>
                    <input type="text" name="fstandardprice" maxlength="20"
                        class="required number"  value="<fmt:formatNumber value="${fautotrade.fstandardprice }" pattern="##.######" maxIntegerDigits="10" maxFractionDigits="6"/>"/>
                </dd>
            </dl>
        </div>
        <div class="formBar">
