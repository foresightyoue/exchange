                ...
                <div class="col-xs-10 padding-right-clear">
                    <div class="col-xs-12 padding-right-clear padding-left-clear rightarea withdraw">
                        ...
                        <c:forEach items="${ftransfer }" varStatus="vs" var="v">
                                <li>
                                    <div style="margin-bottom: .62rem;">
                                        <div class="flexLayout">
                                            <span class="record_hint">划转时间</span>
                                            <span class="record_hint">划转状态</span>
                                        </div>
                                        <div class="flexLayout">
                            ...
                            <%-- <tr>
                                <td width="270"><fmt:formatDate value="${v.fCreateTime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                <td width="200">${v.fAccount }</td>
