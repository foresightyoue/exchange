...
<body>
	<div class="content">
		<div class="head">
			...
			<div class="Personal-title">转账</div>
		</div>
		<div class="main">
			<div class="income">收益区RYH数量&nbsp;&nbsp;&nbsp;&nbsp;<span id="ryhFlow">0.000000</span></div>
			<div class="income">收益区RYB数量&nbsp;&nbsp;&nbsp;&nbsp;<span id="rybFlow">0.000000</span></div>
			<div class="page">
				...
				<div class="page">
					...
					<div class="form">
						...
						<div class="row">
							...
							<input type="number" name="ryb_user" id="ryb_user" value="" placeholder="转入账号用户" />
						</div>
					</div>
					<!-- RYB end -->
				</div>
	...
	<script>
		$(function () {
			...
			$(".button").on('click', function (e) {
				...
				/*if(parseFloat(user).toString().length!=11){
					layer.msg('目标账户有误，请重新输入！');
					return
				}*/
				layer.closeAll();
				$('.pswdMask').show();
			...
			function pay() {
				...
				$.post("/m/trade/transferAccount.html", {
					"coinType": coinType,
					"coins": num,
					"pswd": pswd,
					"targetUserId": user
