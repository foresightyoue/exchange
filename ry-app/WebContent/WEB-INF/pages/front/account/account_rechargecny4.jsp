				...
				<div class="col-xs-12 padding-right-clear padding-left-clear rightarea recharge">
					<div class="col-xs-12 rightarea-con">
						<ul class="nav nav-tabs rightarea-tabs">
							<li class="active">
								<a href="${oss_url}/account/rechargeCny.html?type=1">人民币充值</a>
							</li>
						...
						<div class="col-xs-12 padding-clear padding-top-40">
							...
							<a class="recharge-type wechat active" href="/account/rechargeCny.html?type=4"></a>
							...
							<div class="col-xs-12 padding-clear padding-top-30 padding-bottom-30">
								<div class="panel panel-tips">
									...
									<div class="panel-body">
									    <p>&lt ${requestScope.constant['rechageWeiXinDesc'] }</p>
									</div>
								</div>
							</div>
							<div class="col-xs-12 padding-clear padding-top-30">
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content" style="margin-top: 136px;">
				<div class="modal-header">
					...
					<span class="modal-title"> 微信扫码支付 </span>
				</div>
				<div class="modal-body">
					<div class="recharge-dialog">
						<div class="col-xs-4">
							<img class="wechatqrcode" alt="" src="${requestScope.constant['weixinPayImages'] }">
						</div>
						<div class="col-xs-8">
							...
							<div class="content">
								<span>转账金额：<span class="text-danger" id="rechargeDialogAmount">xxx</span></span>
								 <span>姓名：<span>${requestScope.constant['weixinName'] }</span></span>
								  <span>微信账号：<span>${requestScope.constant['weixinNumber'] }</span></span>
							</div>
						</div>
					</div>
				</div>
