                                    ...
                                    <c:choose>
                                        <c:when test="${v.fid==symbol}">
                                            <li class="${v.fid==symbol?'active':'' }">
                                                <a href="${oss_url}/transform/transfer.html?symbol=${v.fid }">${v.fname }/${v.fShortName } 划转至封神榜平台</a>
                                            </li>
                                        </c:when>
                                    </c:choose>
                                </c:forEach>
                                    ...
                                    <div class="col-xs-7 padding-clear form-horizontal">
                                        ...
                                        <c:if test="${isBindGoogle ==true}">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <input id="withdrawTotpCode" class="form-control"
                                                        type="text">
                                                </div>
                                            </div>
                                        </c:if>
                                    ...
                                    <div class="col-xs-12 padding-clear padding-top-30">
                                        <div class="panel panel-tips">
                                            <div class="panel-body">
                                                <p
                                                    style="height: 200px; line-height: 200px; font-size: 30px;"
                                                    align="center">暂无可划转的币种</p>
                                            </div>
                                        </div>
                                    </div>
                                </c:if>
                                    ...
                                    <div class="panel border">
                                        ...
                                        <div id="recordbody0" class="panel-body">
                                            <table class="table">
                                                ...
                                                <c:forEach items="${ftransform }" varStatus="vs" var="v">
                                                    <tr>
