...
<jsp:include page="../comm/header.jsp"></jsp:include>
											...
											<table class="table table-user ">
												...
												<tr>
												   ...
												   <c:if test="${fuser.authGrade =='2' ||fuser.authGrade == '3' }">
												       <td colspan="" class="col-xs-1 user-tr">认证成功</td>
                                                       <td class="col-xs-7 user-tr"></td>
                                                       <td class="col-xs-1 user-tr"></td>
												   </c:if>
												   <c:if test="${fuser.authGrade !='2' && fuser.authGrade !='3' }">
												       <td colspan="" class="col-xs-1 user-tr"><a href="${oss_url}/user/realCertification.html">进行验证</a></td>
                                                       <td class="col-xs-7 user-tr"></td>
                                                       <td class="col-xs-1 user-tr"></td>
												   </c:if>
												   ...
												   <c:if test="${fuser.authGrade !='3'}">
                                                        <td colspan="" class="col-xs-1 user-tr"><a onclick="checkLevel()" href="javascript:void(0);">进行验证</a></td>
                                                       <td class="col-xs-7 user-tr"></td>
                                                       <td class="col-xs-1 user-tr"></td>
                                                   </c:if>
	...
	function checkLevel(){
	   ...
	   if(authGrade != 2 || authGrade != '2'){
		   ...
		   window.location.href="/user/realCertification.html?flag=trade";
	   }
	}
	</script>
</body>
