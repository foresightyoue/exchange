				...
				<div>
					<div class="user-pwd-recovevery-block">
						<form action="/" class="form-horizontal user-registrations text-center">
							<div class="controls">
								<style>
									.h3-tab{ display: block; box-sizing: border-box; width: 100%; padding: 0px 20%; font-size: 23px !important;}
									.h3-tab *{ margin: 0px 10px; color: #43aebd; text-decoration: none; padding-bottom: 10px;}
									.h3-tab span{ border-bottom: 3px solid #43aebd;}
									.h3-tab a{ color: #333;}
									.h3-tab a:hover{ color: #43aebd; text-decoration: none;}
								</style>
								<h3 class="h3-tab">
									<span>短信</span>
									<a href="${oss_url}/user/register.html">邮箱</a>
								</h3>
							</div>
							<div class="form-controls">
								<div class="control-group ">
									<div class="controls">
										<input type="text" id="register-phone" placeholder="手机号码" /></div>
								</div>
								<div class="control-group ">
									<div class="controls">
										<input type="text" id="register-imgcode" placeholder="验证码"/>
										<img class="controls-right btn-imgcode" src="/servlet/ValidateImageServlet?r=<%=new java.util.Date().getTime() %>">
									</div>
								</div>
								<div class="control-group ">
									<div class="controls">
										<input type="text" id="register-msgcode" placeholder="短信验证码"/>
										<a class="controls-right btn-sendmsg" data-msgtype="12" data-tipsid="register-errortips" id="register-sendmessage">发送验证码</a>
									</div>
								</div>
								<div>
									<div class="control-group ">
										<div class="controls">
											<div class="password-input-block position-relative tooltip-component">
												<input type="password" id="register-password" class="password-input" placeholder="输入密码" /></div>
										</div>
									</div>
									<div class="control-group ">
										<div class="controls">
											<div class="password-input-block position-relative tooltip-component">
												<input type="password" id="register-confirmpassword" class="password-input" placeholder="确认密码" /></div>
							...
							<div class="form-actions-light form-controls">
								<font style="vertical-align: inherit;">
									<font style="vertical-align: inherit;">
										<input type="button" id="register-submit" class="btn btn-large btn-default btn-block" value="注册" /></font>
								</font>
							</div>
							<div class="form-controls align-center">
								<p>
									<a href="#">
										<font style="vertical-align: inherit;">
											<a href="${oss_url}/user/login.html" style="vertical-align: inherit;">登录</a></font>
									</a>
								</p>
								<p>
									<a href="#">
										<font style="vertical-align: inherit;">
											<a href="${oss_url}/validate/reset.html" style="vertical-align: inherit;">找回密码</a></font>
									</a>
								</p>
							</div>
						</form>
