...
<link rel="stylesheet" href="/static/front/css/comm/font.css" type="text/css"></link>
<link href="${oss_url}/static/front/css/comm/newHeader.css" media="screen" rel="stylesheet">
<script type="text/javascript" src="${oss_url}/static/front/js/plugin/jquery.min.js"></script>
<script type="text/javascript" src="${oss_url}/static/front/js/plugin/jquery.flexslider-min.js"></script>