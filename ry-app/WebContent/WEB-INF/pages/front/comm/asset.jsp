...
<div class="assets">
	<span> 预估总资产： <span id="headertotalasset" class="text-danger">￥
			<fmt:formatNumber value="${totalCapitalTrade }" pattern="##.##" maxIntegerDigits="15" maxFractionDigits="2" /></span>
	</span>
</div>
...
<div class="assets-btn">
	<a href="${oss_url}/account/rechargeCny.html" class="btn btn-danger btn-block">充值充币</a>
	<a href="${oss_url}/account/withdrawCny.html" class="btn btn-success btn-block">提现提币</a>
</div>