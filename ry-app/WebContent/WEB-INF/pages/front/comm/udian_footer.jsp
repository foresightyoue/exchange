        ...
        <div class="footer-cont clearfix">
            <div class="company">
                <ul>
                    <li>
                        <h2>平台介绍</h2>
                        <p><a href="${oss_url}/about/t_detail.html?id=1">平台简介</a></p>
                        <p><a href="${oss_url}/about/t_detail.html?id=2">法律说明</a></p>
                        <p><a href="${oss_url}/about/t_detail.html?id=4">注册协议</a></p>
                        <p><a href="${oss_url}/about/t_detail.html?id=3">招贤纳士</a></p>
                    </li>
                    <li>
                        <h2>帮助中心</h2>
                        <p><a href="${oss_url}/about/index.html?id=5">注册指南</a></p>
                        <p><a href="${oss_url}/about/index.html?id=6">交易指南</a></p>
                        <p><a href="${oss_url}/about/index.html?id=7">充值指南</a></p>
                        <p><a href="${oss_url}/about/index.html?id=8">转币指南</a></p>
                    </li>
                    <li>
                        <h2>下载帮助</h2>
                        <p><a href="${oss_url}/about/index.html?id=9">API文档</a></p>
                        <p><a href="javascript:;">APP下载</a></p>
                        <p><a href="${oss_url}/about/index.html?id=61">钱包下载</a></p>
                        <p><a href="${oss_url}/question/question.html">在线问答</a></p>
                    </li>
                </ul>
            </div>
            <div class="service">
