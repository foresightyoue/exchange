                ...
                <div class="clearfix btn_group">
                    ...
                    <div class="fr">
                        <div class="btn_group1">
                            <input type="button" onclick="queryorder(0,'${details.fCreateTime}',0,1);" value="上一张买单"/>
                            <input type="button" onclick="queryorder(0,'${details.fCreateTime}',1,1);" value="下一张买单"/>
                        </div>
                        <div class="btn_group1">
                            <input type="button" onclick="queryorder(1,'${details.fCreateTime}',0,1);" value="上一张卖单"/>
                            <input type="button" onclick="queryorder(1,'${details.fCreateTime}',1,1);" value="下一张卖单"/>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function queryorder(type,time,upDown,dataType){
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.code == 200){
                    window.location.href="/ctc/sjdetails1.html?fId="+data.fId;
                }else{
                    layer.msg(data.msg);
                }
            },
