...
<div class="container main-con" style="padding-top: 50px;">
    <div class="row">
                        ...
                        <tbody>
                            ...
                            <c:if test="${list.fStatus != '2' && list.fStatus !='4'}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${oss_url}/ctc/sjdetails.html?fId=${list.fId }" class="btn btn-info btn-xs"><span aria-hidden="true" class="glyphicon glyphicon-comment"></span>详情</a>
                                    </td>
                                </tr>
                                </c:if>
                            </c:forEach>
