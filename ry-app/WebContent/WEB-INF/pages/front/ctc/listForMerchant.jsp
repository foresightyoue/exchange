        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 ...
                 %>
                <div class="panel-body order_list" style="display:block; min-height: 500px;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="user">
                                                ...
                                                <div class="username"><a href="#">${list.nickname}</a></div>
                                            </div>
                                        </td>
                                        <td>${list.fId}</td>
                                   	...
                                   	<input type="hidden" class="fType" value="${list.fType}">
                                        ...
                                        <td>${list.fNum} ${list.fShortName }</td>
                                        ...
                                        <td>
                                            <a href="${oss_url}/ctc/sjdetails1.html?fId=${list.fId }" class="btn btn-info btn-xs"><span aria-hidden="true" class="glyphicon glyphicon-comment"></span>详情</a>
                ...
                <!--已完成订单-->
                <div class="panel-body order_list dealed" style="min-height: 500px;">
					...
					<input type="hidden" class="fType" value="${list.fType}">
                                        ...
                                        <td><span class="text-default">${status[list.fStatus]}</span></td>
                                        <td>
                                            <a href="/ctc/details.html?fId=${list.fId }" class="btn btn-info btn-xs"><span aria-hidden="true" class="glyphicon glyphicon-comment"></span>详情</a>
                                        </td>
                                    </tr>
                                </c:if>
                            </c:forEach>
