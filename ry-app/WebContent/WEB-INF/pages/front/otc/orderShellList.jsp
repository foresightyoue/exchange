	                            ...
	                            <c:forEach var="otcOrder" items="${orderListIng }">
	                                <tr>
	                                    ...
	                                    <td>${otcOrder.floginName }</td>
	                                     <td>
                                            <c:if test="${otcOrder.fType == '1' }">卖出</c:if>
                                            <c:if test="${otcOrder.fType == '2' }">买入</c:if>
                                        </td>
	                                    ...
	                                    <td>
	                                    	...
	                                    	<c:if test="${otcOrder.fType == '1' }">
	                                    		<a href="/otc/payOrder.html?coinType=${coin_id}&orderId=${otcOrder.fOrderId }&type=w3c&eq=w3c&fw=1" style="padding: 5px 10px;background-color: #1db3b4;color: white;border-radius: 4px;float: left;">查看支付情况</a>
	                                    	</c:if>
	                                    	...
	                                    	<c:if test="${otcOrder.fType == '2' }">
	                                            ...
	                                            <c:if test="${otcOrder.fTrade_Status == '1'}">
			                                    	<a href="/otc/payOrder.html?coinType=${coin_id}&orderId=${otcOrder.fOrderId }&fw=1"style="padding: 5px 10px;background-color: #1db3b4;color: white;border-radius: 4px;margin-bottom: 5px;float: left">去支付</a>
			                                    	<a href="/otc/cancleOrder.html?coinType=${coin_id}&orderId=${otcOrder.fOrderId }&fw=1" style="padding: 5px 10px;background-color: #1db3b4;color: white;border-radius: 4px;float: left;">取消订单</a>
		                                    	</c:if>
		                                    	<!-- 如果订单状态为2待验证，显示按钮查看订单详情 -->
		                                    	<c:if test="${otcOrder.fTrade_Status == '2'}">
		                                    		<a href="/otc/appeal.html?coinType=${coin_id}&orderId=${otcOrder.fOrderId }&fw=1"style="padding: 5px 10px;background-color: #1db3b4;color: white;border-radius: 4px;margin-bottom: 5px;float: left">申诉</a>
			                                    	<a href="/otc/payOrder.html?coinType=${coin_id}&orderId=${otcOrder.fOrderId }&fw=1"style="padding: 5px 10px;background-color: #1db3b4;color: white;border-radius: 4px;margin-bottom: 5px;float: left">查看详情</a>
		                                    	</c:if>
	                                    	</c:if>
	                                    </td>
	                                </tr>
