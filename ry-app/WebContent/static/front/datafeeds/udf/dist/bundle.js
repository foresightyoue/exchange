! function (e, t) {
    ...
    var i = function () {
            ...
            return e.prototype.getBars = function (e, t, r, s) {
                ...
                return new Promise(function (a, u) {
                    o._requester.sendRequest(o._datafeedUrl, "history.html", i).then(function (e) {
    ...
    var o = function () {
        ...
        return e.prototype.onReady = function (e) {
            ...
            this._configuration.supports_time && this._send("time.html").then(function (e) {
                var t = parseInt(e);
                isNaN(t) || r(t)
            }).catch(function (e) {
            ...
            if (this._configuration.supports_search) {
                ...
                this._send("search.html", o).then(function (e) {
            ...
            if (this._configuration.supports_group_request) {
                ...
                this._send("symbols.html", i).then(function (e) {
                    void 0 !== e.s ? r("unknown_symbol3") : o(e)
                }).catch(function (e) {
                    n("UdfCompatibleDatafeed: Error resolving symbol: " + c(e)), r("unknown_symbol4")
                })
            }
            ...
            return this._send("config.html").catch(function (e) {
