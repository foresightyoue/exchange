...
$(function () {
    ...
    $("#bindrealinfo-Btn").on("click", function () {
        security1.submitRealCertificationForm(false);
    });

    $('#withdrawCnyAddrBtn').on('click', function () {
        security1.submitWithdrawCnyAddress();
    });
