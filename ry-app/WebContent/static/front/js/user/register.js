var reg = {
	...
	regSubmit : function() {
		...
		if (flag == true) {
			...
			var intro_user = "";
			intro_user = document.getElementById("register-intro").value;
...
$(function() {
	$(".btn-sendmsg").on("click", function() {
		var areacode = $("#register-areaCode").val();
		var phone = $("#register-phone").val();
		var vcode = $("#register-imgcode").val() ;
		var sendVoice = $("#sendVoice").val();
		msg.sendMsgCode($(this).data().msgtype, $(this).data().tipsid, this.id, areacode, phone,vcode,sendVoice);
	});
